...
public class MythicsFeaturesModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<SoulBerryTileEntity>> SOUL_BERRY = REGISTRY.register("soul_berry", () -> BlockEntityType.Builder.of(SoulBerryTileEntity::new, MythicsFeaturesModBlocks.SOUL_BERRY.get()).build(null));
