 ...
 *
 */
package net.mcreator.mythicsfeatures;
...
@Mod("mythics_features")
public class MythicsFeaturesMod {
	public static final Logger LOGGER = LogManager.getLogger(MythicsFeaturesMod.class);
	public static final String MODID = "mythics_features";

	public MythicsFeaturesMod() {
