package net.mcreator.mythicsfeatures.world.features;
...
import net.mcreator.mythicsfeatures.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, MythicsFeaturesMod.MODID);
