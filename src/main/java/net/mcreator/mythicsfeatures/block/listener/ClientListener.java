...
import net.mcreator.mythicsfeatures.block.renderer.SoulBerryTileRenderer;
...
public class ClientListener {
	...
	public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer(MythicsFeaturesModBlockEntities.SOUL_BERRY.get(), context -> new SoulBerryTileRenderer());
	}
}
