...
public class SoulBerryTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public SoulBerryTileEntity(BlockPos pos, BlockState state) {
		super(MythicsFeaturesModBlockEntities.SOUL_BERRY.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<SoulBerryTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<SoulBerryTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("soul_berry");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Soul Berry");
	}
