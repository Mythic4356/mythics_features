package net.mcreator.mythicsfeatures.block.entity;
...
public class AllayMailboxTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public AllayMailboxTileEntity(BlockPos pos, BlockState state) {
		super(MythicsFeaturesModBlockEntities.ALLAY_MAILBOX.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<AllayMailboxTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<AllayMailboxTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("allay_mailbox");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new AllayMailboxGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Allay Mailbox");
	}
